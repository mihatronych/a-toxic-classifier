...
# def user_report(user_id, type, comment):
#     try:
#         return vk_api.users.report(user_ids=user_id, type=type, comment=comment)
...
if __name__ == '__main__':
    ...
    # print(get_post(76818018_4264))
    posts = get_posts("ismaakova")
    # marked_posts = []
    # messages = {}
    ...
    #     it = it + 1
    # print(marked_posts)
    # print(get_posts_comments('degradination', 4412735))
